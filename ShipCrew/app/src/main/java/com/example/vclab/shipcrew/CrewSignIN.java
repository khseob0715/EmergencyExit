...
public class CrewSignIN extends Activity {
    ...
    EditText Crew_Email_Text, Crew_PW_Text, Crew_Name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Crew_Email_Text = (EditText) findViewById(R.id.crew_email);
        Crew_PW_Text = (EditText) findViewById(R.id.crew_password);
        Crew_Name = (EditText) findViewById(R.id.crew_name);
        ...
        authStaceListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null){
                    ...
                    autoLogin.putString("inputId", Crew_Email_Text.getText().toString());
                    autoLogin.putString("inputPwd", Crew_PW_Text.getText().toString());
                    autoLogin.putString("inputName", Crew_Name.getText().toString());
                    loginName = Crew_Name.getText().toString();
        ...
        CrewSignUP_Btn.setOnClickListener(new OnClickListener() { // 처음 아이디 없을 때 가입 시.
            @Override
            public void onClick(View view) {
                if (Crew_Email_Text.getText().toString() == null || Crew_PW_Text.getText().toString() == null || Crew_Name.getText().toString() == null) {
                    return;
                }
                // 아래의 명령으로 회원가입 정보를 넣을 수 있음.
                FirebaseAuth.getInstance()
                        .createUserWithEmailAndPassword(Crew_Email_Text.getText().toString(), Crew_PW_Text.getText().toString())
                        .addOnCompleteListener(CrewSignIN.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                UserProfileChangeRequest userProfileChangeRequest = new UserProfileChangeRequest.Builder().setDisplayName(Crew_Name.getText().toString()).build();

                                task.getResult().getUser().updateProfile(userProfileChangeRequest);

                                final UserModel userModel = new UserModel();
                                userModel.userName = Crew_Name.getText().toString();
    ...
    void loginEvent(){
        firebaseAuth.signInWithEmailAndPassword(Crew_Email_Text.getText().toString(), Crew_PW_Text.getText().toString())
